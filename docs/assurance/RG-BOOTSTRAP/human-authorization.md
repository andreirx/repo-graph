...
## Amendment 1 — the ratified queue order authorizes each queued slice in turn (recorded 2026-09-18)

On 2026-09-14 the human ratified the order of the remaining requirements-grounded slices (recorded the same day in `docs/requirements/README.md`, "RATIFIED ORDER (human 2026-09-14, option A)", commit c1df38d): Q1 CALL-BINDING-RECEIVER-1 → Q3 CPP-INCLUDE-ROOTS-1 → Q4 EXPLAIN-CYCLES-HONEST-1 → Q5 DEPS-ECOSYSTEM-PARTITION-1 → Q6 EXPLAIN-TYPE-SECTIONS-1 → Q7 COMPLEXITY-SCOPE-1 → Q8 DOCS-DISCOVERY-1 → Q9 PYTHON-SELF-BINDING-1 → ALIAS-SUSPICION-1 → SEED-DOCUMENT-1, with CPP-INCLUDE-SUFFIX-1 (RG-REQ-006-L11) and CONCERN-HINTS-1 (RG-REQ-010-L11) ratified but unscheduled. Under that ratification, and under the same limits as above, each slice in that order is authorized — one work item at a time, in order — as a requirements-grounded slice: its stage-3 allocation block and v2 manifest are authored as a requirements-document item admitted under the bootstrap baseline, independently reviewed, and operator-approved before its implementation is admitted. This amendment records an existing human decision; it does not extend the catalog, the roles, the limits, or the release posture. Builder/reviewer for these slices: claude / claude-opus-4-8 and codex / gpt-5.6-terra (human directive 2026-09-13; two-vendor). Q1 shipped 437cc16 (2026-09-18) under this authority before the record was written; the gap was found by the Q3 document review (D-CIR-AUTH-01) and closed here.
