...
use repo_graph_state_extractor::{
    CallsiteLogicalName, EmitError, EmitterContext, LogicalNameSource, StateBoundaryCallsite,
    StateBoundaryEmitter, STATE_BOUNDARY_EVIDENCE_VERSION,
};
...
fn callsite_generic(
    ...
    StateBoundaryCallsite {
        ...
        logical_name: CallsiteLogicalName::Generic(LogicalName::new(logical.to_string()).unwrap()),
