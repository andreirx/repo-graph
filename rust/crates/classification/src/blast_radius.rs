...
use crate::types::{
    BlastRadiusAssessment, BlastRadiusLevel, EnclosingScopeSignificance, ReceiverOrigin,
...
fn derive_receiver_origin(basis_code: UnresolvedEdgeBasisCode) -> ReceiverOrigin {
    match basis_code {
        UnresolvedEdgeBasisCode::ThisReceiverImpliesInternal => ReceiverOrigin::ThisBound,
        ...
        | UnresolvedEdgeBasisCode::CalleeMatchesSameFileSymbol => ReceiverOrigin::SameFileDeclared,
        UnresolvedEdgeBasisCode::ReceiverMatchesRuntimeGlobal
        | UnresolvedEdgeBasisCode::CalleeMatchesRuntimeGlobal => ReceiverOrigin::RuntimeGlobal,
        UnresolvedEdgeBasisCode::SpecifierMatchesRuntimeModule => ReceiverOrigin::RuntimeModule,
        UnresolvedEdgeBasisCode::NoSupportingSignal => ReceiverOrigin::LocalLike,
...
/// `blast-radius.ts:132`.
fn derive_enclosing_scope_significance(visibility: Option<&str>) -> EnclosingScopeSignificance {
    match visibility {
        Some("export") | Some("public") => EnclosingScopeSignificance::ExportedPublic,
...
fn compute_radius(origin: ReceiverOrigin, scope: EnclosingScopeSignificance) -> BlastRadiusLevel {
    match origin {
