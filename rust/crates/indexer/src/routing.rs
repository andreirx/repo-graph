...
pub fn build_extension_routing_table(extractors: &[&dyn ExtractorPort]) -> BTreeMap<String, usize> {
...
pub fn route_file(file_path: &str, routing_table: &BTreeMap<String, usize>) -> Option<usize> {
...
mod tests {
    ...
    fn language_to_extensions_typescript() {
        assert_eq!(
            language_to_extensions("typescript"),
            &[".ts", ".mts", ".cts"]
        );
    }
    ...
    fn language_to_extensions_javascript() {
        assert_eq!(
            language_to_extensions("javascript"),
            &[".js", ".mjs", ".cjs"]
        );
    }
