...
impl StorageConnection {
    ...
    pub fn delete_edges_by_uids(&self, edge_uids: &[String]) -> Result<(), StorageError> {
...
mod tests {
    ...
    fn setup_with_two_nodes(storage: &mut StorageConnection) -> (String, String, String) {
        ...
        storage.insert_nodes(&[na.clone(), nb.clone()]).unwrap();
