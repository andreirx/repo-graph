-- 001-initial.sql
-- Canonical schema for Repo-Graph.
-- Backend-neutral SQL: no SQLite-specific or Postgres-specific idioms.
-- All primary keys are TEXT UIDs for global portability.
