...
use repo_graph_gate::{
    ...
    GateQualityAssessmentFact, GateQualityPolicyKind, GateQualityPolicySeverity, GateRequirement,
    GateStorageError, GateStorageRead, GateWaiver,
};
...
/// gate layer.
fn map_err<E: std::fmt::Display>(operation: &'static str) -> impl FnOnce(E) -> GateStorageError {
    ...
    fn get_quality_assessment_facts_for_gate(
        ...
        for policy in &policies {
            ...
            if let Some(assessment) = assessment {
                ...
                let computed_verdict =
                    map_verdict(&assessment.computed_verdict).map_err(|reason| {
