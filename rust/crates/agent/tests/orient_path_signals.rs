...
use repo_graph_agent::{
    orient, AgentBoundaryDeclaration, AgentCycle, AgentImportEdge, AgentPathResolution,
...
fn path_focus_gate_filters_by_target_prefix() {
    ...
    fake.gate_boundary_declarations.insert("r1".into(), vec![]);
    let result = orient(
        &fake,
        "r1",
        Some("src/core"),
