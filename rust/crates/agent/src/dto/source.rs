...
impl SourceRef {
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::StorageFindImportsBetweenPaths => "storage::find_imports_between_paths",
            ...
            Self::StorageQueryHighComplexitySymbols => "storage::query_high_complexity_symbols",
            Self::StorageGetBoundaryLinksFreshness => "storage::get_boundary_links_freshness",
