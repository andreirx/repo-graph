...
mod tests {
    ...
    fn else_if_does_not_add_nesting() {
        let m = metrics_for("function f() { if (a) {} else if (b) {} else {} }");
    ...
    fn nested_function_not_counted() {
        let m = metrics_for("function f() { function inner() { if (x) {} } }");
    ...
    #[test]
    fn cognitive_switch() {
        let m = metrics_for("function f() { switch (x) { case 1: break; case 2: break; } }");
    ...
    fn cognitive_deeply_nested() {
        let m = metrics_for("function f() { if (a) { if (b) { if (c) {} } } }");
        // +1 for outer if
    ...
    fn cognitive_nested_function_boundary() {
        let m = metrics_for("function f() { if (x) {} function inner() { if (y) {} } }");
